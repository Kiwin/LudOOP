using Ludoop.Backend.MomsSpaghetti.Backend.Pieces;
using Ludoop.Backend.MomsSpaghetti.Backend.Tiles;
using System;
...
namespace Ludoop.Backend.MomsSpaghetti.Backend.Backend
{
    ...
    public class GameBoard
    {
        ...
        private void initializeMaps()
        {
            ...
            for (int i = 0; i < submaps.Length; i++)
            {
                ...
                sharedMap.SetTile(idx, new ExitTile(sharedMap, idx, submaps[i].FirstTile, (Team)(i))); //Create exit tiles.
                sharedMap.SetTile(idx+1, new SpawnTile(sharedMap, idx+1, (Team)(i))); //Create spawn tiles.
                submaps[i].LastTile = new EndTile(submaps[i], submaps[i].Tiles.Length - 1, (Team)(i)); //Create end tiles.
            }
